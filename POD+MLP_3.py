...
SAVE_DIR = r'C:\Users\Lenovo\Desktop\POD-1.26'  # Changed save directory to avoid overwriting
...
for i, idx in enumerate(tqdm(val_idx, desc="Validating Cases")):
    ...
    print(f"Case {idx + 1:2d}: MAE={mae:.4f} °C, RMSE={rmse:.4f} °C, rRMSE={rRMSE_case:.4f}")
...
# ======================================================================
# Calculate rRMSE_n for 10 pre-selected high-temperature points0.0800.
# ======================================================================
...
for point_idx in pre_selected_indices:
    ...
    # For context, print the average temperature at this point from the training set
...
plt.plot(df_metrics["Case"], df_metrics["rRMSE"], '-^', label="rRMSE (relative)")
