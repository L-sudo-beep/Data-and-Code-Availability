...
# ==============================
# 区域范围设置
# 每个区域用 xmin, xmax, ymin, ymax, zmin, zmax 定义
# 如果某一方向为固定平面，例如 x=2.8，则 xmin=xmax=2.8
# ==============================
...
def axis_region_mask(values, vmin, vmax, tol=1e-8):
    ...
    若 vmin != vmax，则选取范围 [vmin, vmax] 内的点；
    若 vmin == vmax，说明该方向是一个平面，则自动选取最接近该坐标的网格面。
    """
